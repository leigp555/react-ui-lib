...
import { Divider, Paragraph, Text, Title, Typography } from '../../lib';
    ...
    <div className="Eg">
      <div className="showEg">
        <Typography>
          ...
          <Paragraph>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aspernatur commodi corporis
            debitis, doloribus ducimus error excepturi exercitationem facilis id iure maxime modi
            nostrum optio quas recusandae repellendus sed suscipit? (<Text code>Lorem</Text> and
          ...
          <Paragraph>
            ...
            quam quibusdam quod reiciendis rem reprehenderit, rerum sed ullam voluptates
            voluptatum.。
          </Paragraph>
